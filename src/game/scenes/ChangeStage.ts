    ...
    if (this._gameStage) {
      switch (this._gameStage?.status) {
        ...
        case GAME_STATUS_ENUM.RESTART:
          // When restarting after death, keep lives and stage, but reset other values
          const currentLives = this._gameStage.lives;
          const currentStage = this._gameStage.stage;
          const currentTotalScore = this._gameStage.totalScore;
          
          this._gameStage = getInitialGameStage();
          // Restore lives and stage, keep total score
          this._gameStage.lives = currentLives;
          this._gameStage.stage = currentStage;
          this._gameStage.totalScore = currentTotalScore;
